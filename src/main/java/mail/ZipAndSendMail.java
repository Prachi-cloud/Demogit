...
public class ZipAndSendMail
{
	...
	static String[] toEmails = { "prachikhandelwal99@gmail.com"};
	static String fromUser = "prachikhandelwal99@gmail.com";// imap on, other devices on, no recovery phone
	static String password = "AUMN@000";
